      ...
      . unfold NormalizeX at *
        ...
        . split at H <;> rename_i H1
          . split <;> rename_i H2
            . split <;> rename_i H3
              . unfold NormalizeY at *
                split at H <;> rename_i H4
                . clear H0
                  split at H3 <;> rename_i H5
                  . split <;> rename_i H6
                    . simp at *
                      clear H2
                      obtain H | H := H
                      ...
                      · obtain ⟨H7, H8⟩ := H
                        ...
                        . obtain ⟨H9, H10⟩ := H3
                          ...
                          . obtain H10 | H10 := H10
                            ...
                            . obtain ⟨H11, H12⟩ := H10
                              exfalso
                              clear H1 H4 H5 H6 H12
                              omega
                          . obtain ⟨H11, H12⟩ := H8
                            obtain H10 | H10 := H10
                            . clear H12 H1 H4 H5 H6
                              exfalso
                              omega
                            . obtain ⟨H13, H14⟩ := H10
                              clear H13
